...
export default function UsersToolbar(props) {
   const [addUser, setAddUser] = useState(false)
    return (
        <div className="  sm:flex sm:flex-row  md:items-center md:justify-between px-2 py-3 lg:px-8">
           {addUser && <AddUserModal open={addUser} setOpen={setAddUser} />}
                <div className="flex-1 min-w-0">
                    <h2 className="text-2xl font-bold leading-7 text-white sm:text-3xl sm:truncate">Manage Users</h2>
                </div>
