...
export default function NabarTop() {
  const {data: session, status} = useSession()
  const router = useRouter();
  const navigation = [
    // { name: 'How To Donate', href: '/donate', current: router.pathname === '/donate' ? true : false },
    // // { name: 'Meet Cacoon', href: '/about', current: router.pathname === '/about' ? true : false  },
    // { name: 'Catering', href: '/catering', current: router.pathname === '/catering' ? true : false  },
  ]
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-purple-600 text-white text-2xl' : 'text-indigo-600 hover:bg-purple-600 hover:text-white  text-2xl',
